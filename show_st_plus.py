...
import joblib
from autoint_plus import AutoIntMLPModel, predict_model
...
def load_data():
    ...
    field_dims = np.load(f'{data_path}/field_dims_tuned.npy')
    dropout= 0.3
    embed_dim= 32
    ...
    model.load_weights(f'{model_path}/autoIntMLP_model_tuned.weights.h5')
    label_encoders = joblib.load(f'{data_path}/label_encoders_tuned.pkl')
